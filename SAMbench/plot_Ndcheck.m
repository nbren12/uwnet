...
clear out
  ...
  switch ncase
   case 1
    casename = '2D_256x128_50m_5m_0.5s_20160209';
    fig0 = 20;
    microname = 'THOM';
    plottag = 'RF02: THOMPSON, 2D, days 223-224';
    filetag = 'RF02_THOMP_NdSensitivity';
   case 2
    casename = '2D_256x128_50m_5m_0.5s_20160209';
    fig0 = 20;
    microname = 'M2005';
    plottag = 'RF02: M2005, 2D, days 223-224';
    filetag = 'RF02_M2005_NdSensitivity';
   case 3
    casename = '2D_256x128_50m_5m_0.5s_20160209';
    fig0 = 40;
    microname = 'DRIZZLE';
    plottag = 'RF02: DRIZZLE, 2D, days 223-224';
    filetag = 'RF02_DRIZZLE_NdSensitivity';
   otherwise 
    error('bad ncase value');
  end

n = 1;
out(n).nc = sprintf('OUT_STAT/DYCOMS_RF02_%s_MPDATA_CAM_%s.nc',casename,microname);
out(n).name = 'CAM Nd=55'; n = n + 1;
out(n).nc = sprintf('OUT_STAT/DYCOMS_RF02b_%s_Nd150_MPDATA_CAM_%s.nc',casename,microname);
out(n).name = 'CAM Nd=150'; n = n + 1;
out(n).nc = sprintf('OUT_STAT/DYCOMS_RF02c_%s_Nd1000_MPDATA_CAM_%s.nc',casename,microname);
out(n).name = 'CAM Nd=1000'; n = n + 1;
out(n).nc = sprintf('OUT_STAT/DYCOMS_RF02_%s_MPDATA_RRTM_%s.nc',casename,microname);
out(n).name = 'RRTM Nd=55'; n = n + 1;
out(n).nc = sprintf('OUT_STAT/DYCOMS_RF02b_%s_Nd150_MPDATA_RRTM_%s.nc',casename,microname);
out(n).name = 'RRTM Nd=150'; n = n + 1;
out(n).nc = sprintf('OUT_STAT/DYCOMS_RF02c_%s_Nd1000_MPDATA_RRTM_%s.nc',casename,microname);
out(n).name = 'RRTM Nd=1000'; n = n + 1;
