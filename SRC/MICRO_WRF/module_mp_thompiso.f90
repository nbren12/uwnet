...
!..Local variables
      ...
      REAL, DIMENSION(kts:kte,nproc_rates_mass_thompson_cold) :: mass_proc_rates
      REAL, DIMENSION(kts:kte,nproc_rates_number_thompson_cold) :: number_proc_rates
      ...
      REAL, DIMENSION(kts:kte,nproc_rates_mass_thompson_cold,niso_max) :: &
           iso_mass_proc_rates
...
!..Sub arguments
      ...
      REAL, DIMENSION(kts:kte,nproc_rates_mass_thompson_cold), INTENT(INOUT) :: mass_proc_rates
      REAL, DIMENSION(kts:kte,nproc_rates_number_thompson_cold), INTENT(INOUT) :: number_proc_rates
      LOGICAL, INTENT(IN) :: dosedimentation, do_accum_proc_rates
      ...
      REAL, DIMENSION(kts:kte,nproc_rates_mass_thompson_cold,niso), INTENT(INOUT) :: &
           iso_mass_proc_rates
!..Local variables
!bloss: Note on units.
!  q*ten is in kg/kg/s.
