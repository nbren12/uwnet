...
character(len=128) :: version='$Id: constants.f90,v 11.0.12.2 2005/05/20 01:26:37 pjp Exp $'
...
real, public, parameter :: CPH2OVAPOR = 1846.
...
! Noah: Actually that dependency is unnessary so I will just do this here
PI = 4.0*ATAN(1.0)
RADIAN = 180.0/PI
