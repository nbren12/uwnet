...
n = 1;
out(n).nc = 'OUT_STAT/DYCOMS_RF02_2D_256x128_50m_5m_0.5s_MPDATA_RRTM_DRIZZLE.nc';
out(n).name = 'DRZ'; n = n + 1;
out(n).nc = 'OUT_STAT/DYCOMS_RF02_2D_256x128_50m_5m_0.5s_MPDATA_RRTM_M2005.nc';
out(n).name = 'M2005'; n = n + 1;
out(n).nc = 'OUT_STAT/DYCOMS_RF02_2D_256x128_50m_5m_0.5s_MPDATA_RRTM_THOM.nc';
out(n).name = 'THOM'; n = n + 1;
out(n).nc = 'OUT_STAT/DYCOMS_RF02_2D_256x128_50m_5m_0.5s_MPDATA_RRTM_SAM1MOM.nc';
out(n).name = 'SAM1MOM'; n = n + 1;
...
for q = 1:length(out)
  ...
  which = {'time','z','p','CWP','IWP','RWP','SWP', ...
           ...
           'RADQR','RADQRLW','RADQRSW','WOBS','RHO', ...
...
for kk = 1:length(stufftoplot)
  ...
  hL1 = plot_pldata('time, day',stufftoplot{kk}{2},'',-1,out,'time', ...
                    stufftoplot{kk}{1});
